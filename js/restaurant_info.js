...
fillRestaurantHTML = (restaurant = self.restaurant) => {
  ...
  name.classList.add(restaurant.type.toLowerCase() + '-color');

  const rating = document.querySelector('.rating');
  rating.innerHTML = 'Rating: ' + restaurantRating(restaurant); //'rating';
  rating.classList.add(restaurant.type.toLowerCase());
  ...
  location.innerHTML = restaurant.place;

  const address = document.getElementById('restaurant-address');
  address.innerHTML = restaurant.address;
  address.setAttribute('aria-label', 'Address: ' + restaurant.address + ', ' + restaurant.place);



  const type = document.getElementById('restaurant-cuisine');
  type.innerHTML = restaurant.type;
  type.classList.add(restaurant.type.toLowerCase());
  type.setAttribute('aria-label', 'restaurant type: ' + restaurant.type);
